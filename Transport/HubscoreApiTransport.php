...
final class HubscoreApiTransport extends AbstractApiTransport
{
    private string $key;
    ...
    {
        return sprintf('hub+api://%s', $this->getEndpoint());
    }

    protected function doSendApi(SentMessage $sentMessage, Email $email, Envelope $envelope): ResponseInterface
    {
        $response = $this->client->request('POST', 'https://'.$this->getEndpoint().'/v1/sends/mails', [
        ...
        try {
            ...
            throw new HttpTransportException('Could not reach the remote Hubscore server.', $response, 0, $e);
        }
    ...
    {
        return ($this->host ?: 'api.hub-score.com').($this->port ? ':'.$this->port : '');
    }
}
